...
$aimg=md5($aimg).time().$extension;
 move_uploaded_file($_FILES["image"]["tmp_name"],$_SERVER['DOCUMENT_ROOT']."/lan/images/".$aimg);
    $query=mysqli_query($con, "update art set Image='$aimg' where ID='$aniid'");
    if ($query) {
    echo '<script>alert("Art Collection image has been Updated.")</script>';
...
<head>
    ...
    <title>Update Art Collection Image - LAN Digital Arts Network</title>
                    ...
                    <div class="col-lg-12 col-ml-12">
                        <div class="row">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Update Art Collection Detail</h4>
                                        <form method="post" enctype="multipart/form-data">
                                            <?php
 $aniid=$_GET['editid'];
$ret=mysqli_query($con,"select * from art where ID='$aniid'");
$cnt=1;
...
?>
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="aname" name="aname" aria-describedby="emailHelp" placeholder="Enter art name" value="<?php  echo $row['Name'];?>" readonly="true">
                                            </div>
                                       
                                           <div class="form-group">
                                                <label for="exampleInputEmail1">Old Image</label>
                                                <img src="/lan/images/<?php  echo $row['Image'];?>" width="100" height="100">
                                            </div>
                                          <div class="form-group">
