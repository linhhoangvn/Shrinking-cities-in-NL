...
if(isset($_POST['submit']))
  {
    ...
    echo '<script>alert("Art Collection details has been updated.")</script>';
...
<head>
    ...
    <title>Edit Art Collection - LAN Digital Arts Network</title>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <?php
 $partid=$_GET['editid'];
$ret=mysqli_query($con,"SELECT a.ID as ArtID,a.Name as ArtName,a.Image as Image,a.Price as Price,a.Category as Category,a.Type as Type,a.Size as Size,a.Quantity as Quantity,a.Description as Description, ar.Name as ArtistName,CONCAT(FirstName, ' ', LastName) AS UserName FROM art a INNER JOIN artist ar ON a.ArtistID = ar.ID LEFT JOIN user u ON a.UserID = u.ID   where a.ID='$partid'");
$cnt=1;
...
?>
                                           ...
                                           <div class="form-group">
                                                ...
                                                <img src="/lan/images/<?php  echo $row['Image'];?>" width="100" height="100"> <a href="change-art-collection-image.php?editid=<?php echo $row['ArtID'];?>"> &nbsp; Edit Image</a>
                                            </div>
                                           <div class="form-group">
