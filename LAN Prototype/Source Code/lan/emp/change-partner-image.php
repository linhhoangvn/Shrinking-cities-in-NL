...
$aimg=md5($aimg).time().$extension;
 move_uploaded_file($_FILES["image"]["tmp_name"],$_SERVER['DOCUMENT_ROOT']."/lan/images/".$aimg);
    $query=mysqli_query($con, "update partner set Image='$aimg' where ID='$aniid'");
    if ($query) {
  
    echo '<script>alert("Partner image has been Updated.")</script>';
  }
  else
    {
...
<head>
    ...
    <title>Update Partner Image - LAN Digital Arts Network</title>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <?php
 $aniid=$_GET['editid'];
$ret=mysqli_query($con,"select * from partner where ID='$aniid'");
$cnt=1;
...
?>
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="aname" name="aname" aria-describedby="emailHelp" placeholder="Enter partner name" value="<?php  echo $row['Name'];?>" readonly="true">
                                            </div>
