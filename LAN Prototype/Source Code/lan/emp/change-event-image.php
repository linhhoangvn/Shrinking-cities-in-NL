...
$aimg=md5($aimg).time().$extension;
 move_uploaded_file($_FILES["image"]["tmp_name"],$_SERVER['DOCUMENT_ROOT']."/lan/images/".$aimg);
    $query=mysqli_query($con, "update event set Image='$aimg' where ID='$aniid'");
    if ($query) {
    echo '<script>alert("Event image has been Updated.")</script>';
...
<head>
    ...
    <title>Update Event Image - LAN Digital Arts Network</title>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <?php
 $aniid=$_GET['editid'];
$ret=mysqli_query($con,"select * from event where ID='$aniid'");
$cnt=1;
