...
if(isset($_POST['submit']))
  {
	...
	$acprice=$_POST['price'];
	$acreview=$_POST['review'];
	$acdesc=$_POST['desc'];
	$acdesc= mysqli_real_escape_string($con,$_POST['desc']);
    $query=mysqli_query($con, "update art set Name='$acname',Category='$accat',Type='$actype',Size='$acsize',Quantity='$acquantity',Price='$acprice',Review='$acreview',Description='$acdesc' where ID='$partid'");
    if ($query) {
...
?>
						...
						<select id="review" name="review" class="form-control" required="true">
            <option value="<?php  echo $row['Review'];?>">Select Review</option>
