        ...
        <div class="main-content">
          ...
          onchange="if(this.options[this.selectedIndex].value=='newArtist'){
            ...
            onblur="if(this.value==''){toggleField(this,this.previousSibling);}">
						...
						<select id="usid" name="usid" class="form-control">
            <option value="">Select User</option>
							<?php 
			$query=mysqli_query($con,"SELECT id, CONCAT(FirstName, ' ', LastName) AS FullName from user where type = 0 order by FullName");
			while ($row=mysqli_fetch_array($query)) {
							?>
