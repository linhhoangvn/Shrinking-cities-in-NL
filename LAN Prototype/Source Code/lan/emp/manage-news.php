...
<head>
    ...
    <title>Manage News - LAN Digital Arts Network</title>
...
?>
          ...
          <tr data-expanded="true">
            <td><?php  echo $row['ID'];?></td>
				  ...
				  <td><a href="edit-news-details.php?editid=<?php echo $row['ID'];?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
					<a onClick="return confirm('Are you sure you want to delete?')" href="manage-news.php?del=<?php echo $row['ID'];?>"><i class="fa fa-close"></i></a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
