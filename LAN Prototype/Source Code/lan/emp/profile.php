...
check_login();
  ...
  {
    $id=$_SESSION['lanempid'];
    $fname=$_POST['fname'];
    $lname=$_POST['lname'];
     $query=mysqli_query($con, "update employee set FirstName='$fname',LastName='$lname' where ID='$id'");
    if ($query) {
...
<head>
    ...
    <title>Employee Profile - LAN Digital Arts Network</title>
...
<body>
   ...
   <?php
$id=$_SESSION['lanempid'];
$ret=mysqli_query($con,"select * from employee where ID='$id'");
$cnt=1;
