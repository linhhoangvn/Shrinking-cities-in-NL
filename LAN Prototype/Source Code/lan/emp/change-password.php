...
{
$empid=$_SESSION['lanempid'];
$cpassword=md5($_POST['currentpassword']);
$newpassword=md5($_POST['newpassword']);
$query=mysqli_query($con,"select ID from employee where ID='$empid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update employee set Password='$newpassword' where ID='$empid'");
...
<head>
    ...
    <title>Change Password - LAN Management System</title>
